...
#  For instance, a turtle is generally considered a reptile. Although modern cladistics call this categorization into question,
#  for purposes of this exercise we will say turtles are reptiles!:
...
# Next, let’s practice composition a little bit. This one will require a second type of Animal that is in 
# the same category as the first. For example, since you already created a Turtle class, go ahead and create a Snake class. 
...
# Below we have the Zoo class. We’re going to use it to organize our various Animals. 
# Remember, inheritance says a Turtle is an Animal, but a Zoo is not an Animal and an 
